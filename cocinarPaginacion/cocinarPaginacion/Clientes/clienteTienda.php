                ...
                <ul class="list-unstyled templatemo-accordion">
                    <li class="pb-3">
                        ...
                        <ul class="collapse show list-unstyled pl-3">
                            <li><a class="text-decoration-none" href="#">Alimento</a></li>
                            <li><a class="text-decoration-none" href="#">Higiene</a></li>
                        </ul>
                    </li>
                    <!--
                    <li class="pb-3">
            ...
            <div class="col-lg-9">
                ...
                <div class="row">
                    <?php
                        ...
                        if($link){
                            $query=null;
                            sql_ConsultaTienda($link,$query);
                            if(mysqli_num_rows($query) > 0){
                                while($row = mysqli_fetch_array($query)){
                                    $id=$row['idProducto'];
                                    $nombreProd=$row['nombreProducto'];
                                    $cantProd=$row['cantidadProducto'];
                                    $costProd=$row['costoProducto'];
                                    $descriProd=$row['descripcionProducto'];
                                                    ...
                                                    <div class="card rounded-0">
                                                        ...
                                                        <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                                            <ul class="list-unstyled">
                                                                ...
                                                                <li><a class="btn btn-success text-white mt-2" href="clienteproducto.php?id=<?php echo $id; ?>"><i class="far fa-eye"></i></a></li>
                                                                <!--<li><a class="btn btn-success text-white mt-2" href="shop-single.html"><i class="fas fa-cart-plus"></i></a></li>-->
                                                            </ul>
                                                        </div>
                                                    </div>
                                                    <div class="card-body">
                                                        <a href="shop-single.html" class="h3 text-decoration-none"><?php echo "$nombreProd"; ?> </a>
                                                        <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
                                                            <li>Cantidad: <?php echo "$cantProd" ?></li>
                                                            <li class="pt-2">
                                                        ...
                                                        -->
                                                        <p class="text-center mb-0">$ <?php echo "$costProd"; ?> </p>
                                                    </div>
                                                </div>
                                            </div>
                                    <?php
